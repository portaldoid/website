...
?>
	...
	<div id="primary" class="content-area">
		<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			<div class="row">
				<div class="col">
		    		<input type="text" class="field form-control" name="s" id="s" placeholder="<?php esc_attr_e( 'Produsen', 'twentyeleven' ); ?>" />
				</div>
				<div class="col">
					<input type="text" class="field form-control" name="category_label" id="category_label" placeholder="<?php esc_attr_e( 'Daerah Produksi', 'twentyeleven' ); ?>" />
					...
					if ( !empty($production_types) ) :
					    $output_production_types = '<select name="tipe_produksi" class="form-control">';
						    ...
						    foreach( $production_types as $production_type ) {
								$output_production_types.= '<option value="'. esc_attr( $production_type->slug ) .'">
