...
?>
	...
	<div id="primary" class="content-area">
        <?php
            $_nama_penerima = $_GET['s'] != '' ? $_GET['s'] : '';
            $_keperluan = $_GET['keperluan'] != '' ? $_GET['keperluan'] : '';
        ?>
		<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			<div class="row">
				<div class="col">
		    		<input type="text" class="field form-control" name="s" id="s" placeholder="<?php esc_attr_e( 'Nama Penerima', 'twentyeleven' ); ?>" value="<?php echo $_nama_penerima; ?>" />
				</div>
				<div class="col">
				...
				<div class="col">
		    		<input type="text" class="field form-control" name="keperluan" id="keperluan" placeholder="<?php esc_attr_e( 'Keperluan', 'twentyeleven' ); ?>" value="<?php echo $_keperluan; ?>" />
				</div>
				<div class="col p-l-0">
